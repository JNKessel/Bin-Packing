...
3.2.1	Como funcionam os Algoritmos Genéticos
DESCRIÇÃO
...
3.2.2	Alterações para o Trabalho
3.2.2.1	Estrutura
VETOR DE INTEIROS
...
3.2.2.3.2.1	Recombinação ou Crossover
DESCRIÇÃO
...
3.2.2.3.3	Formação de Famílias
...
3.2.2.4	Classificação
3.2.2.4.1	Classificação dos Indivíduos
...
3.2.2.4.2	Avaliação Geral do Algoritmo
...
3.2.2.4.3	Probabilidade de Mutação
...
3.2.2.6	Métodos de Alocação de Itens
3.2.2.6.1	First Fit
...
3.3	Busca Local
3.3.1	Como funciona uma Busca Local
DESCRIÇÃO
...
Fim Enquanto
3.3.2	Alterações para o Trabalho
...
3.3.2.3.5	Perturbação
Na vizinhança Perturbação, sorteia-se um item de um bin A e tenta inserir em um bin B ao mesmo tempo que se sorteia um item do bin B e tenta inserir em um bin C. Isso é repetido ate se encontrar um movimento viável ou acabarem as combinações de bins 3 a 3.
...
3.3.2.4	Método de alocação de itens

3.3.2.4.1	First Fit
O método de First Fit utilizado para alocar os itens de um vetor de inteiros em bins consiste em retirar os itens do vetor um a um e tentar coloca-los em algum bin já existente, caso não seja possível então cria-se um bin para receber o item.

3.3.2.4.2	Personalizado
